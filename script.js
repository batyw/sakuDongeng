(() => {
    const SAVE_KEY = "petualanganDongengNusantara.v1";
    ...
    const stories = [
      {
        ...
        miniQuiz: {
          question: "Bawang Putih menemukan 3 labu kecil dan 2 labu besar. Berapa jumlah seluruh labu?",
          options: ["4", "5", "6"],
          correct: 1,
          praise: "Benar! 3 + 2 = 5 labu. Kamu teliti seperti Bawang Putih."
        },
        choice2: {
        ...
        logicQuiz: {
          question: "Urutan yang tepat adalah...",
          options: ["Menolong nenek, lalu berterima kasih", "Marah dulu, lalu menolong", "Memilih hadiah sebelum membantu"],
          correct: 0,
          praise: "Tepat! Menolong dulu, lalu berterima kasih adalah urutan sikap yang baik."
        },
        storyQuiz: {
          question: "Menurut cerita asli, labu mana yang dipilih Bawang Putih?",
          options: ["Besar", "Sedang", "Kecil"],
          correct: 2,
          praise: "Hebat! Bawang Putih memilih labu kecil karena ia rendah hati."
        },
        finalChoice: {
      ...
      },
      {
        ...
        miniQuiz: {
          question: "Di kapal ada 2 karung beras dan 3 keranjang ikan. Berapa semua bekal itu?",
          options: ["4", "5", "6"],
          correct: 1,
          praise: "Benar! 2 + 3 = 5 bekal. Perjalanan jadi lebih siap."
        },
        choice2: {
        ...
        logicQuiz: {
          question: "Mana kalimat yang menunjukkan sikap hormat kepada orang tua?",
          options: ["Aku malu punya ibu miskin.", "Terima kasih, Ibu, atas doamu.", "Jangan panggil aku lagi."],
          correct: 1,
          praise: "Tepat! Ucapan terima kasih adalah tanda hormat dan sayang."
        },
        storyQuiz: {
          question: "Dalam cerita asli, apa akibat Malin durhaka kepada ibunya?",
          options: ["Menjadi batu", "Menjadi raja", "Menjadi burung"],
          correct: 0,
          praise: "Benar! Cerita Malin Kundang mengingatkan kita untuk menghormati orang tua."
        },
        finalChoice: {
      ...
      },
      {
        ...
        miniQuiz: {
          question: "Timun Mas membawa 4 biji mentimun dan 3 butir garam ajaib. Berapa benda ajaib yang dihitungnya?",
          options: ["6", "7", "8"],
          correct: 1,
          praise: "Benar! 4 + 3 = 7. Menghitung membantu Timun Mas tetap tenang."
        },
        choice2: {
        ...
        logicQuiz: {
          question: "Jika ingin menyeberang tempat licin, benda ajaib apa yang paling cocok menjadi lumpur atau laut?",
          options: ["Garam", "Kelereng", "Pensil"],
          correct: 0,
          praise: "Tepat! Dalam cerita, garam dapat berubah menjadi laut yang menghalangi raksasa."
        },
        storyQuiz: {
          question: "Siapa yang memberi benda ajaib kepada Timun Mas?",
          options: ["Mbok Rondo", "Malin", "Bawang Merah"],
          correct: 0,
          praise: "Hebat! Mbok Rondo menolong Timun Mas dengan bekal ajaib."
        },
        finalChoice: {
      ...
      },
      {
        ...
        miniQuiz: {
          question: "Ada 6 batang kayu dan 2 lentera di tepi danau. Berapa jumlah semuanya?",
          options: ["7", "8", "9"],
          correct: 1,
          praise: "Benar! 6 + 2 = 8. Perhitungan rapi membantu pekerjaan besar."
        },
        choice2: {
        ...
        logicQuiz: {
          question: "Jika ada tugas besar, mana rencana yang paling masuk akal?",
          options: ["Membagi pekerjaan kecil-kecil", "Menunda sampai lupa", "Merusak alat kerja"],
          correct: 0,
          praise: "Tepat! Tugas besar lebih mudah bila dibagi menjadi langkah kecil."
        },
        storyQuiz: {
          question: "Legenda Sangkuriang sering dikaitkan dengan terbentuknya gunung apa?",
          options: ["Tangkuban Perahu", "Semeru", "Rinjani"],
          correct: 0,
          praise: "Benar! Perahu yang terbalik dikaitkan dengan Gunung Tangkuban Perahu."
        },
        finalChoice: {
      ...
      },
      {
        ...
        miniQuiz: {
          question: "Nenek menaruh 5 bunga dan 4 daun di meja. Berapa hiasan semuanya?",
          options: ["8", "9", "10"],
          correct: 1,
          praise: "Benar! 5 + 4 = 9 hiasan. Meja nenek jadi indah."
        },
        choice2: {
        ...
        logicQuiz: {
          question: "Apa arti kata 'tulus' dalam cerita ini?",
          options: ["Menolong tanpa mengharap hadiah", "Menolong agar dipuji", "Menolong sambil mengejek"],
          correct: 0,
          praise: "Tepat! Tulus berarti berbuat baik dengan hati ikhlas."
        },
        storyQuiz: {
          question: "Dalam cerita Keong Mas, wujud ajaib sang putri adalah...",
          options: ["Keong emas", "Burung merak", "Ikan perak"],
          correct: 0,
          praise: "Benar! Sang putri berubah menjadi keong emas."
        },
        finalChoice: {
    ...
    function currentTotals(includeSession = true) {
      ...
      if (includeSession && session && !session.saved) {
        totals.reading += session.scores.reading;
        totals.quiz += session.scores.quiz;
        totals.decision += session.scores.decision;
      }
    ...
    function getBadges(totals = currentTotals()) {
      ...
      return [
        ...
        { id: "expert", name: "🏆 Ahli Dongeng", unlocked: totals.quiz >= 60 || completedCount >= 5 || totals.total >= 180 }
      ];
    }
        ...
        <div class="game">
          <section class="start-overlay">
            <div class="start-card">
              ...
              <h1 class="hero-title">Petualangan Dongeng Nusantara</h1>
      ...
      app.innerHTML = shell(`
        <div class="screen center-screen menu">
          <div>
            ...
            <p class="subtitle">Setiap cerita memiliki pilihan, kuis, dan tiga kemungkinan ending. Coba ulang untuk menemukan jalan cerita berbeda.</p>
            <div class="badge-row">${badges}</div>
            <div class="menu-grid">${cards}</div>
            <div class="action-row">
              <button class="small-btn" data-action="show-eval">Lihat / Isi Evaluasi</button>
              <button class="small-btn" data-action="reset-save">Reset Skor</button>
            </div>
          </div>
        </div>
      `);
    ...
    function startStory(storyId) {
      ...
      session = {
        story,
        step: 0,
        scores: { reading: 0, quiz: 0, decision: 0 },
        wisdom: 0,
        pagesRead: 0,
        choices: {},
        quizCorrect: {},
    ...
    function renderPlay() {
      ...
      let dialogue = "";
      let speaker = story.hero;
      let choiceTitle = "";
      let choices = "";
      let artMood = type.includes("Quiz") ? "quiz" : "calm";

      if (type.startsWith("intro")) {
        const index = Number(type.replace("intro", ""));
        dialogue = story.intro[index];
        choiceTitle = "Baca halaman ini, lalu lanjut.";
        choices = `<button class="primary" data-action="next-story">Lanjut</button>`;
      } else if (type === "bridge1") {
        dialogue = story.bridge1;
        speaker = "Narator";
        choiceTitle = "Kamu mendapat +2 skor membaca saat melanjutkan.";
        choices = `<button class="primary" data-action="next-story">Lanjut</button>`;
      } else if (type === "bridge2") {
        dialogue = "Cerita makin seru. Setiap jawaban dan keputusan membantumu memahami pesan dongeng.";
        speaker = "Narator";
        choiceTitle = "Lanjut ke kuis berbasis cerita.";
        choices = `<button class="primary" data-action="next-story">Lanjut</button>`;
      } else if (type === "preEnding") {
        dialogue = story.preEnding;
        speaker = "Narator";
        choiceTitle = "Lihat ending pilihanmu.";
        choices = `<button class="primary green" data-action="next-story">Lihat Ending</button>`;
      } else if (type === "choice1" || type === "choice2" || type === "finalChoice") {
        const choiceData = story[type];
        dialogue = choiceData.prompt;
        speaker = "Pilihan";
        artMood = "choice";
        choiceTitle = "Pilih satu tindakan.";
        choices = choiceData.options.map((option, index) => `
          <button class="choice-btn" data-action="choose" data-choice-key="${type}" data-index="${index}">${String.fromCharCode(65 + index)}. ${esc(option.text)}</button>
        `).join("");
        ...
        const picked = session.choices[key];
        dialogue = picked ? picked.reply : "Pilihanmu membuat cerita bergerak ke halaman berikutnya.";
        speaker = "Akibat Pilihan";
        choiceTitle = "Setiap tindakan punya akibat.";
        choices = `<button class="primary" data-action="next-story">Lanjut</button>`;
      } else if (type === "miniQuiz" || type === "logicQuiz" || type === "storyQuiz") {
        const quiz = story[type];
        const solved = session.quizCorrect[type];
        speaker = type === "miniQuiz" ? "Mini Quiz" : type === "logicQuiz" ? "Kuis Logika" : "Kuis Cerita";
        dialogue = quiz.question;
        choiceTitle = solved ? quiz.praise : "Pilih jawaban yang benar. Jika salah, coba lagi.";
        choices = quiz.options.map((option, index) => `
          <button class="choice-btn ${solved && index === quiz.correct ? "correct" : ""}" data-action="answer-quiz" data-quiz-key="${type}" data-index="${index}" ${solved ? "disabled" : ""}>${String.fromCharCode(65 + index)}. ${esc(option)}</button>
        `).join("");
    ...
    function nextStory() {
      if (!session) return;
      const type = stepTypes[session.step];
      const readingSteps = ["intro0", "intro1", "intro2", "bridge1", "bridge2", "preEnding", "choice1Result", "choice2Result", "finalResult"];
      if (readingSteps.includes(type)) {
        session.scores.reading += 2;
        session.pagesRead += 1;
      }
      session.feedback = "";
    ...
    function choose(key, index) {
      if (!session) return;
      const data = session.story[key];
      const option = data.options[index];
      if (!option) return;
      session.choices[key] = option;
      session.scores.decision += option.points;
      session.wisdom += option.wisdom;
      session.feedback = option.points >= 15 ? `Pilihan bijaksana! +${option.points} poin keputusan.` : option.points > 0 ? `Pilihan ini cukup aman. +${option.points} poin keputusan.` : "Pilihan ini kurang bijaksana. Cerita tetap berlanjut.";
      session.feedbackType = option.points >= 15 ? "good" : option.points > 0 ? "" : "bad";
      session.step += 1;
      option.points >= 15 ? playCorrect() : playButton();
      renderPlay();
    }

    function answerQuiz(key, index) {
      if (!session) return;
      const quiz = session.story[key];
      if (!quiz || session.quizCorrect[key]) return;
      if (Number(index) === quiz.correct) {
        session.quizCorrect[key] = true;
        session.scores.quiz += 10;
        session.feedback = `${quiz.praise} +10 poin kuis.`;
        session.feedbackType = "good";
        playCorrect();
      } else {
        session.feedback = "Belum tepat. Baca petunjuk cerita, lalu coba lagi.";
    ...
    function finalizeSession() {
      ...
      const totalQuiz = Object.keys(session.quizCorrect).length;
      const type = session.wisdom >= 4 && totalQuiz >= 2 ? "good" : session.wisdom <= 0 ? "bad" : "neutral";
      session.endingType = type;
      session.endingReached = true;
      session.saved = true;
      save.reading += session.scores.reading;
      save.quiz += session.scores.quiz;
      save.decision += session.scores.decision;
      if (!save.completed.includes(session.story.id)) save.completed.push(session.story.id);
      const sessionTotal = session.scores.reading + session.scores.quiz + session.scores.decision;
      save.storyBest[session.story.id] = Math.max(save.storyBest[session.story.id] || 0, sessionTotal);
      persist();
    }
    ...
    function renderEnding() {
      ...
      finalizeSession();
      const story = session.story;
      const ending = story.endings[session.endingType || "neutral"];
        ...
        <div class="screen">
          <div class="summary-card">
            ...
            <div class="stat-grid">
              ...
              <div class="stat"><b>Total Cerita</b><strong>${total}</strong></div>
            </div>
            <div class="badge-row">${badges}</div>
            <div class="action-row">
              <button class="primary green" data-action="show-eval">Isi Evaluasi</button>
              <button class="primary alt" data-action="menu">Pilih Cerita Lain</button>
              <button class="primary soft" data-action="restart-story">Ulang Cerita</button>
            </div>
          </div>
        </div>
      `);
    ...
    function renderEvaluation() {
      const favoriteOptions = stories.map((story) => `<option value="${story.id}" ${session && session.story.id === story.id ? "selected" : ""}>${esc(story.title)}</option>`).join("");
      app.innerHTML = shell(`
        <div class="screen">
          <form class="eval-card eval-form" data-eval-form>
            <h2>Evaluasi Minat Baca</h2>
            <p class="notice">Isi singkat, ya. Jawabanmu membantu mengetahui seberapa menyenangkan membaca cerita di game ini.</p>

            <fieldset class="field">
              <legend>1. Apakah game ini menyenangkan?</legend>
              <div class="radio-row">
                ${["😞", "😐", "😊", "😄"].map((emoji, i) => `<label class="emoji-chip"><input type="radio" name="fun" value="${i + 1}" required><span>${emoji}</span></label>`).join("")}
              </div>
            </fieldset>

            <label class="field"><span class="main-label">2. Cerita mana yang paling kamu sukai?</span><select name="favoriteStory" required>${favoriteOptions}</select></label>

            <fieldset class="field">
              <legend>3. Bagian apa yang paling kamu sukai?</legend>
              <div class="radio-row">
                ${["Membaca cerita", "Memilih jalan cerita", "Menjawab quiz", "Melihat gambar"].map((part) => `<label class="radio-chip"><input type="radio" name="favoritePart" value="${esc(part)}" required><span>${esc(part)}</span></label>`).join("")}
              </div>
            </fieldset>

            <label class="field"><span class="main-label">4. Apa yang ingin kamu tambahkan di game ini?</span><textarea name="wish" placeholder="Contoh: cerita baru, gambar baru, atau kuis lebih banyak"></textarea></label>

            <div class="field">
              <label class="main-label">Bagian 2 – Pengukuran Minat Baca (1 = tidak setuju, 5 = sangat setuju)</label>
              ${[
                "Saya senang membaca cerita di game ini.",
                "Saya ingin membaca cerita rakyat lainnya setelah bermain.",
                "Saya tertarik mengetahui akhir cerita yang berbeda.",
                "Saya ingin bermain sambil membaca lagi di lain waktu.",
                "Saya merasa membaca cerita menjadi lebih menyenangkan."
              ].map((question, qIndex) => `
                <fieldset class="field" style="background:#fffaf0;">
                  <legend>${qIndex + 1}. ${esc(question)}</legend>
                  <div class="radio-row">
                    ${[1,2,3,4,5].map((value) => `<label class="scale-chip"><input type="radio" name="interest${qIndex}" value="${value}" required><span>${value}</span></label>`).join("")}
                  </div>
                </fieldset>
              `).join("")}
            </div>
            ...
            <div class="action-row">
              <button type="button" class="primary alt" data-action="menu">Kembali</button>
              <button type="button" class="primary green" data-action="submit-eval">Lihat Hasil</button>
            </div>
          </form>
        </div>
      `);
    ...
    function submitEvaluation() {
      ...
      let interest = 0;
      for (let i = 0; i < 5; i += 1) interest += Number(data.get(`interest${i}`) || 0);
      const percent = Math.round((interest / 25) * 100);
      const result = {
        date: new Date().toISOString(),
        fun: Number(data.get("fun")),
        favoriteStory: data.get("favoriteStory"),
        favoritePart: data.get("favoritePart"),
        wish: data.get("wish") || "",
        interestPercent: percent
      };
      save.evaluations.push(result);
      persist();
      playCorrect();
      renderEvalResult(result);
    }

    function categoryFor(percent) {
      if (percent >= 80) return "Minat Baca Sangat Tinggi";
      if (percent >= 60) return "Minat Baca Tinggi";
      if (percent >= 40) return "Minat Baca Sedang";
      if (percent >= 20) return "Minat Baca Rendah";
      return "Minat Baca Sangat Rendah";
    }

    function renderEvalResult(result) {
      const totals = currentTotals(false);
      const badges = getBadges(totals).map((badge) => `<span class="badge ${badge.unlocked ? "unlocked" : ""}">${badge.name}</span>`).join("");
      const favorite = stories.find((story) => story.id === result.favoriteStory)?.title || "Cerita rakyat";
      app.innerHTML = shell(`
        <div class="screen center-screen">
          <div class="summary-card">
            <h2>Hasil Evaluasi</h2>
            <p class="notice">Cerita favoritmu: <strong>${esc(favorite)}</strong>. Bagian favorit: <strong>${esc(result.favoritePart)}</strong>.</p>
            <div class="stat-grid">
              <div class="stat"><b>Total Skor</b><strong>${totals.total}</strong></div>
              <div class="stat"><b>Minat Baca</b><strong>${result.interestPercent}%</strong></div>
            </div>
            <p class="notice"><strong>${categoryFor(result.interestPercent)}</strong></p>
            <div class="badge-row">${badges}</div>
            <div class="action-row">
              <button class="primary green" data-action="menu">Main Lagi</button>
            </div>
          </div>
        </div>
      `);
    ...
    function sceneSvg(story, mood) {
      const id = story.id;
      const [c1, c2] = story.colors;
      const sky2 = mood === "ending" ? "#fff4a7" : "#aeeeff";
      const sparkle = mood === "quiz" || mood === "ending" ? 1 : 0;
      const place = placeShapes(story.place, id, c1, c2);
      return `
        <svg class="story-art" viewBox="0 0 900 430" role="img" aria-label="Ilustrasi ${esc(story.title)}" preserveAspectRatio="xMidYMid slice">
          <defs>
            <linearGradient id="sky-${id}" x1="0" x2="0" y1="0" y2="1"><stop stop-color="#e9fbff"/><stop offset="1" stop-color="${sky2}"/></linearGradient>
            <linearGradient id="ground-${id}" x1="0" x2="1"><stop stop-color="${c1}"/><stop offset="1" stop-color="${c2}"/></linearGradient>
          </defs>
          <rect width="900" height="430" fill="url(#sky-${id})"/>
          <circle cx="760" cy="72" r="43" fill="#ffdb65" opacity=".95"/>
          <g class="cloud" fill="#fff" opacity=".82"><ellipse cx="145" cy="80" rx="48" ry="22"/><ellipse cx="190" cy="77" rx="55" ry="26"/><ellipse cx="235" cy="85" rx="38" ry="18"/></g>
          <g class="cloud" fill="#fff" opacity=".72"><ellipse cx="520" cy="96" rx="42" ry="19"/><ellipse cx="560" cy="91" rx="50" ry="23"/><ellipse cx="602" cy="99" rx="35" ry="16"/></g>
          ${place}
          <path d="M0 348 C150 294 266 335 400 306 C544 274 686 302 900 266 L900 430 L0 430 Z" fill="url(#ground-${id})" opacity=".93"/>
          <path d="M350 430 C412 374 470 344 545 318 C490 374 485 405 510 430 Z" fill="#f7d08a" opacity=".95"/>
          ${heroShape(story, c1, c2)}
          <g transform="translate(102 292)">
            <circle class="spark" cx="0" cy="0" r="9" fill="#fff17a" opacity="${sparkle ? 1 : .3}"/>
            <text x="20" y="18" font-size="58">${story.icon}</text>
          </g>
          <g fill="#fff8a7" opacity="${sparkle ? .95 : .28}" class="spark"><path d="M710 155 l8 18 18 8 -18 8 -8 18 -8-18 -18-8 18-8z"/><path d="M160 180 l6 13 13 6 -13 6 -6 13 -6-13 -13-6 13-6z"/></g>
        </svg>
      `;
    }
    ...
    function placeShapes(place, id, c1, c2) {
      if (place === "sea") return `
        <path d="M0 278 C90 252 175 305 270 278 C360 250 445 305 540 278 C640 246 735 306 900 268 L900 430 L0 430 Z" fill="#3cb7e9" opacity=".8"/>
        <path d="M0 315 C120 287 230 336 340 310 C470 280 590 334 700 310 C780 292 835 300 900 292" fill="none" stroke="#e9fbff" stroke-width="8" opacity=".72"/>
        <g transform="translate(210 235)"><path d="M0 65 L180 65 L145 105 L32 105 Z" fill="#a86433"/><path d="M90 0 L90 65" stroke="#74401f" stroke-width="8"/><path d="M98 10 L162 52 L98 52 Z" fill="#fff0b3"/></g>
      `;
      if (place === "forest") return `
        <g fill="#3eaa44"><circle cx="110" cy="236" r="58"/><circle cx="160" cy="210" r="62"/><circle cx="230" cy="238" r="56"/><circle cx="716" cy="218" r="70"/><circle cx="790" cy="250" r="62"/></g>
        <g fill="#8a552b"><rect x="145" y="218" width="28" height="140" rx="11"/><rect x="750" y="220" width="32" height="140" rx="12"/></g>
        <path d="M90 130 C135 170 150 210 135 283" fill="none" stroke="#2c8a3a" stroke-width="18"/><path d="M804 120 C756 172 742 216 758 290" fill="none" stroke="#2c8a3a" stroke-width="18"/>
      `;
      if (place === "mountain") return `
        <path d="M110 328 L330 98 L544 328 Z" fill="#7fb1ca"/><path d="M330 98 L392 165 L300 162 Z" fill="#fff7df"/>
        <path d="M390 330 L622 130 L832 330 Z" fill="#9a8ad7"/><path d="M622 130 L686 196 L586 194 Z" fill="#fff7df"/>
        <ellipse cx="608" cy="350" rx="210" ry="38" fill="#61c8ed" opacity=".82"/>
      `;
      if (place === "palace") return `
        <g transform="translate(120 142)"><rect x="0" y="105" width="285" height="150" rx="18" fill="#ffcf7e"/><rect x="35" y="50" width="70" height="205" fill="#f59a64"/><rect x="180" y="50" width="70" height="205" fill="#f59a64"/><path d="M20 50 L70 0 L120 50 Z" fill="#d95847"/><path d="M165 50 L215 0 L265 50 Z" fill="#d95847"/><rect x="115" y="130" width="56" height="125" rx="28" fill="#8d5432"/></g>
        <path d="M560 292 C610 254 680 248 744 294" fill="none" stroke="#e8a53c" stroke-width="20" stroke-linecap="round"/>
      `;
      return `
        <g transform="translate(90 178)"><rect x="0" y="80" width="190" height="116" rx="12" fill="#c1783c"/><path d="M-20 84 L94 0 L210 84 Z" fill="#8d4f28"/><rect x="25" y="120" width="42" height="76" fill="#70401f"/><rect x="104" y="112" width="48" height="42" fill="#aeeeff"/></g>
        <g transform="translate(635 168)"><rect x="0" y="88" width="170" height="106" rx="12" fill="#d0904b"/><path d="M-15 92 L80 20 L185 92 Z" fill="#92582b"/><rect x="72" y="122" width="42" height="72" fill="#714222"/></g>
        <path d="M42 306 C88 250 110 218 108 140" fill="none" stroke="#6aa33d" stroke-width="16"/><path d="M82 190 C38 166 28 140 38 112" fill="none" stroke="#5aa031" stroke-width="13"/>
      `;
    }
    ...
    function heroShape(story, c1, c2) {
      ...
      return `
        <g class="hero-bob" transform="translate(610 174)">
          <ellipse cx="88" cy="210" rx="82" ry="18" fill="rgba(81,49,24,.22)"/>
          <path d="M46 88 C36 120 42 164 20 202 L158 202 C135 163 142 116 126 88 Z" fill="${outfit}" stroke="#62351d" stroke-width="5"/>
          <circle cx="86" cy="58" r="48" fill="#ffd29c" stroke="#62351d" stroke-width="5"/>
          <path d="M42 48 C60 8 113 5 132 46 C108 28 76 26 42 48 Z" fill="#63351f"/>
          <circle cx="70" cy="62" r="5" fill="#3f2415"/><circle cx="102" cy="62" r="5" fill="#3f2415"/>
          <path d="M73 84 Q87 96 104 84" fill="none" stroke="#8b3e2b" stroke-width="5" stroke-linecap="round"/>
          <path d="M48 112 C12 120 2 148 26 166" fill="none" stroke="#ffd29c" stroke-width="18" stroke-linecap="round"/>
          <path d="M126 112 C166 119 174 148 148 168" fill="none" stroke="#ffd29c" stroke-width="18" stroke-linecap="round"/>
          <rect x="55" y="198" width="22" height="60" rx="10" fill="#3f7d49"/><rect x="100" y="198" width="22" height="60" rx="10" fill="#3f7d49"/>
          <text x="52" y="162" font-size="58">${story.icon}</text>
        </g>
      `;
    }
    ...
    function ensureAudio() {
      if (!audio) {
        ...
        audio.master.gain.value = soundOn ? 0.18 : 0;
    ...
    function startMusic() {
      ...
      ensureAudio();
      const notes = [392, 440, 523, 494, 440, 392, 330, 392];
      let index = 0;
      musicTimer = setInterval(() => {
        if (!soundOn) return;
        tone(notes[index % notes.length], .18, "sine", .045);
        index += 1;
      }, 720);
    }
    ...
    function toggleSound() {
      ...
      if (session && stepTypes[session.step] === "ending") renderEnding();
      else if (session) renderPlay();
      else renderMenu();
    }
    ...
    app.addEventListener("click", (event) => {
      ...
      if (action !== "toggle-sound") ensureAudio();
      if (soundOn) startMusic();

      if (action === "open-menu") { playButton(); renderMenu(); }
      if (action === "menu") { session = null; playButton(); renderMenu(); }
      ...
      if (action === "restart-story" && session) startStory(session.story.id);
      ...
      if (action === "reset-save") {
        if (confirm("Reset semua skor dan evaluasi sementara?")) {
          save = defaultSave();
          soundOn = true;
          session = null;
          persist();
